...
//let user7SecondCopy = structuredClone(user7);
// console.log(user7);
// console.log(user7Copy);
// console.log(user7 === user7Copy);
// console.log(user7.studies === user7Copy.studies);
// console.log(user7.studies.exams === user7Copy.studies.exams);
