...
.DATA																;сегмент данных
Array			SDWORD	 -5, 5, 23, -1, 25, 9, -466, 22, 9, 0	
consoleTitle	BYTE	'My Console',0
...
int_to_char PROC uses eax ebx ecx edi esi,
	...
	cdq																;Расширяет знак числа, размещая старший бит знака в регистре edx. Это нужно для правильного выполнения деления.
