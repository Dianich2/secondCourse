...
namespace OOP_lab13
{
    public class CustomSerializer
    {
        public static void SerializeToBinary<T>(T obj) where T : class
        {
            ...
            using (var fileStream = new FileStream(@"D:\Study\university\3semester\OOP\Labs\lab13\OOP_lab13\Binary.bin", FileMode.OpenOrCreate))
            {
        ...
        public static void SerializeToSoap<T>(T obj) where T : class
        {
            ...
            using (var fileStream = new FileStream(@"D:\Study\university\3semester\OOP\Labs\lab13\OOP_lab13\SOAP.soap", FileMode.OpenOrCreate))
            {
        ...
        public static void SerializeToXml<T>(T obj) where T : class
        {
            ...
            using (var fileStream = new FileStream(@"D:\Study\university\3semester\OOP\Labs\lab13\OOP_lab13\XML.xml", FileMode.OpenOrCreate))
            {
        ...
        public static void SerializeToJson<T>(T obj) where T : class
        {
            ...
            using (var fileStream = new StreamWriter(@"D:\Study\university\3semester\OOP\Labs\lab13\OOP_lab13\JSON.json"))
            {
        ...
        {
            var settings = new JsonSerializerSettings { TypeNameHandling = TypeNameHandling.All };
            using (var fileStream = new StreamReader(@"D:\Study\university\3semester\OOP\Labs\lab13\OOP_lab13\JSON.json"))
            {
